...
public class ExamReportGenerator {
   ...
   public static String type ;
    ...
    public static Response genarateReport(Connection conn, String database_type, long ExamId) {
        type = database_type;
        try (Connection connection = conn) {
            ...
            try (PreparedStatement statement = connection.prepareStatement(query)) {
                ...
                try (ResultSet resultSet = statement.executeQuery()) {
                    ...
                    return new Response(200,"Finished generating excel file");
                }
            }
        } catch (Exception e) {
            return new Response(505,"Internal server error");
        }
    }
    ...
    public static Map<Long, Integer> getSubjectMarks(long examId) throws Exception {
        ...
        if(checker.getStatus()){
            connection = new FileReader("config/"+checker.getMessage());
