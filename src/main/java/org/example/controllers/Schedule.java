...
public class Schedule {
    public static Response addSchedule(Connection conn, Map<String, String> values){
    ...
    public static Response updateSchedule(Connection conn, Map<String, String> values,String id){
        Response result = null;
        try {
